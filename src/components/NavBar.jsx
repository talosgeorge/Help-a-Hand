...
export default function NavBar({ role, onOpenCreateRequest }) {
    ...
    // Check if the current route is either /voluntar/requests or /beneficiar/requests
    const shouldShowGoBackButton = location.pathname === "/voluntar/requests" || location.pathname === "/beneficiar/requests";
