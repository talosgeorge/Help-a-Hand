export default function RequestContainer({ request, onDelete, onAccept, onComplete }) {
  ...
  return (
      ...
      >
        ...
        <div className={`relative z-10 p-5 flex flex-col justify-between h-full ${hasBackgroundImage ? "text-white" : "text-gray-800"}`}>
